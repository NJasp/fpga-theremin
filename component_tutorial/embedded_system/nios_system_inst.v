	nios_system u0 (
		...
		.video_ext_1_PIXEL_CLK       (<connected-to-video_ext_1_PIXEL_CLK>),       //          video_ext_1.PIXEL_CLK
		.video_ext_1_LINE_VALID      (<connected-to-video_ext_1_LINE_VALID>),      //                     .LINE_VALID
		.video_ext_1_FRAME_VALID     (<connected-to-video_ext_1_FRAME_VALID>),     //                     .FRAME_VALID
		.video_ext_1_pixel_clk_reset (<connected-to-video_ext_1_pixel_clk_reset>), //                     .pixel_clk_reset
		.video_ext_1_PIXEL_DATA      (<connected-to-video_ext_1_PIXEL_DATA>)       //                     .PIXEL_DATA
	);
